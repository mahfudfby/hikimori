// src/pages/Home.tsx
// CRA + TypeScript — NO Tailwind, NO lucide-react
// Uses only inline styles, CSS vars from index.css, and react-icons
                  ...
                  <>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, background: '#f9fafb', borderRadius: 16, padding: '10px 16px' }}>
                      ...
                      <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
                        <SocialBtn icon={<FaTwitter size={13} />} bg="#f3f4f6" color="#1f2937" />
                        <SocialBtn icon={<MdOutlineCircle size={13} />} bg="#fce7f3" color="#ec4899" />
                        <SocialBtn icon={<FaInstagram size={13} />} bg="#ffedd5" color="#fb923c" />
                        <SocialBtn icon={<FaLinkedinIn size={13} />} bg="#dbeafe" color="#2563eb" />
                      </div>
                    </div>
