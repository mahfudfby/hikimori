...
const D_EXP:ExpItem[]=[
  ...
  {id:'6',position:'Driver Bike',company:'Grab (Transportasi & Logistik Online)',period:'Februari 2022 – Desember 2025 · 3 Tahun 11 Bulan · Part-time',icon:'🏍️',tags:'',desc:'• Mengantar penumpang dengan aman dan tepat waktu\n• Mengantar pesanan makanan (GrabFood)\n• Mengantar paket/barang (GrabExpress)\n• Melayani titip belanja (GrabMart)\n• Menjaga rating dan kepuasan pelanggan\n• Mematuhi standar keselamatan berkendara',location:'Jakarta, Indonesia'},
  {id:'7',position:'Crew',company:'PT. Richeese Kuliner Indonesia (Makanan & Minuman)',period:'Oktober 2023 – Januari 2024 · 4 Bulan · Contract',icon:'🍗',tags:'Cooking,Platting',desc:'• Memasak ayam goreng crispy sesuai SOP dan standar resep\n• Meracik sauce/saus sesuai standar rasa perusahaan\n• Melakukan food preparation harian (marinasi, potong, susun stok)\n• Menjaga kualitas dan kebersihan bahan baku (food safety)\n• Merekap inventory harian (stok masuk, terpakai, sisa stok)\n• Melaporkan kebutuhan restock ke supervisor/leader shift\n• Berkoordinasi dengan tim dapur dan kasir untuk kelancaran operasional\n• Menjaga kecepatan penyajian sesuai target service time',location:'Indonesia'},
  {id:'8',position:'Kitchen Staff',company:'Mikane Gepuktular (Kuliner)',period:'Januari 2023 – November 2023 · 11 Bulan · Part-time',icon:'👨\u200d🍳',tags:'',desc:'• Sebagai Juru Masak Dan Persiapan Bahan Mentah',location:'Malang, Jawa Timur'},
  {id:'9',position:'Crew',company:'Mie Gacoan (Makanan & Minuman)',period:'Oktober 2022 – Desember 2022 · 3 Bulan · Contract',icon:'🍜',tags:'Hospitality Industry,Food and Beverage Operations',desc:'• Hospitality Customer',location:'Indonesia'},
  {id:'10',position:'Welding Operator',company:'Lancar Jaya Kota Malang (Bengkel Las & Konstruksi)',period:'Agustus 2018 – Januari 2021 · 2 Tahun 6 Bulan · Freelance',icon:'🔩',tags:'Welding,Project Planning',desc:'• Operator welder pembuatan pagar, tralis, kanopi, rolling door, dll hingga finishing serta pemasangan di lapangan',location:'Kota Malang, Jawa Timur'},
  {id:'11',position:'Human Resources Assistant',company:'Dinas Sosial PPPA Kab Nganjuk (Instansi Pemerintah)',period:'Mei 2017 – Juni 2018 · 1 Tahun 2 Bulan · Full-time',icon:'🏛️',tags:'Sumber Daya Manusia (SDM),Project Management',desc:'• Staff SDM bertugas dalam menyiapkan materi untuk anggota Forum Perlindungan Anak Nganjuk untuk mewujudkan nganjuk kabupaten layak anak',location:'Nganjuk, Jawa Timur'},
  {id:'12',position:'Human Resources Assistant',company:'Dinas Kesehatan Nganjuk (Instansi Pemerintah)',period:'Maret 2016 – Mei 2017 · 1 Tahun 3 Bulan · Full-time',icon:'🏛️',tags:'Sumber Daya Manusia (SDM),Project Management',desc:'• Sebagai staff yang menangani perencanaan kegiatan dan agenda program kerja dalam mensosialisasikan kesehatan remaja di kabupaten nganjuk',location:'Nganjuk, Jawa Timur'}
];
const D_EXP_EN:ExpItem[]=[
  ...
  {id:'6',position:'Driver Bike',company:'Grab (Ride-Hailing & On-Demand Logistics)',period:'Feb 2022 – Dec 2025 · 3 Years 11 Months · Part-time',icon:'🏍️',tags:'',desc:'• Delivered passengers safely and on time\n• Delivered food orders (GrabFood)\n• Delivered packages/goods (GrabExpress)\n• Handled shopping requests (GrabMart)\n• Maintained customer rating and satisfaction\n• Complied with driving safety standards',location:'Jakarta, Indonesia'},
  {id:'7',position:'Crew',company:'PT. Richeese Kuliner Indonesia (Food & Beverage)',period:'Oct 2023 – Jan 2024 · 4 Months · Contract',icon:'🍗',tags:'Cooking,Plating',desc:'• Cooked crispy fried chicken per SOP and recipe standards\n• Prepared sauces to the company\u2019s taste standards\n• Performed daily food preparation (marinating, cutting, stock arrangement)\n• Maintained raw-material quality and cleanliness (food safety)\n• Recorded daily inventory (stock in, used, remaining)\n• Reported restock needs to the supervisor/shift leader\n• Coordinated with the kitchen and cashier team for smooth operations\n• Maintained serving speed to meet service-time targets',location:'Indonesia'},
  {id:'8',position:'Kitchen Staff',company:'Mikane Gepuktular (Culinary)',period:'Jan 2023 – Nov 2023 · 11 Months · Part-time',icon:'👨\u200d🍳',tags:'',desc:'• Cook and raw-material preparation',location:'Malang, Jawa Timur'},
  {id:'9',position:'Crew',company:'Mie Gacoan (Food & Beverage)',period:'Oct 2022 – Dec 2022 · 3 Months · Contract',icon:'🍜',tags:'Hospitality Industry,Food and Beverage Operations',desc:'• Hospitality customer service',location:'Indonesia'},
  {id:'10',position:'Welding Operator',company:'Lancar Jaya Kota Malang (Welding & Construction)',period:'Aug 2018 – Jan 2021 · 2 Years 6 Months · Freelance',icon:'🔩',tags:'Welding,Project Planning',desc:'• Welding operator producing fences, railings, canopies, rolling doors, etc. through finishing and on-site installation',location:'Kota Malang, Jawa Timur'},
  {id:'11',position:'Human Resources Assistant',company:'Dinas Sosial PPPA Kab Nganjuk (Government Agency)',period:'May 2017 – Jun 2018 · 1 Year 2 Months · Full-time',icon:'🏛️',tags:'Human Resources,Project Management',desc:'• HR staff preparing materials for the Nganjuk Child Protection Forum to support a child-friendly Nganjuk regency',location:'Nganjuk, Jawa Timur'},
  {id:'12',position:'Human Resources Assistant',company:'Dinas Kesehatan Nganjuk (Government Agency)',period:'Mar 2016 – May 2017 · 1 Year 3 Months · Full-time',icon:'🏛️',tags:'Human Resources,Project Management',desc:'• Staff handling planning of activities and program agendas for youth-health outreach in Nganjuk regency',location:'Nganjuk, Jawa Timur'}
];
                  ...
                  <AnimatePresence>
                    {!compact&&(
                      <motion.div initial={{opacity:0,height:0}} animate={{opacity:1,height:'auto'}} exit={{opacity:0,height:0}} transition={{duration:0.3}} style={{overflow:'hidden'}}>
                        ...
                        {location&&<div style={{color:'rgba(234,242,248,0.55)',fontSize:'0.82rem',marginBottom:'0.5rem',display:'flex',alignItems:'center',gap:'0.35rem'}}><span aria-hidden="true">📍</span>{location}</div>}
                        {totalDuration&&(
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'1.2rem'}}>
              {groupExpByCompany(exps,lang).map((row,i)=>(
                row.type==='group'
                  ...
                  : <ExpDrilldown key={row.item.id} company={row.item.company.split(' (')[0].trim()} items={[row.item]} totalDuration={computeTotalDuration([row.item],lang)} index={i}/>
              ))}
            </div>
          </div>
        </div>
